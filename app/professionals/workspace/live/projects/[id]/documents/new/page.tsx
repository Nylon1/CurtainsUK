  ...
  return (
    <main className="min-h-screen bg-apex-navy-950 px-4 pb-24 pt-32 text-white sm:px-6 lg:px-8 lg:pt-40">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mt-4 text-4xl font-semibold sm:text-6xl">Register a drawing, schedule, survey or photo set.</h1>
        <p className="mt-5 max-w-3xl leading-8 text-[#C8D1D8]">Revision and evidence status matter. Registering a file does not mean it is suitable for manufacture, fixing approval or final specification.</p>
        <form action={action} className="mt-10 rounded-[32px] border border-white/10 bg-[#1B405B] p-7 sm:p-9">
          ...
          <button className="mt-7 rounded-full bg-[#d6b56b] px-6 py-3 text-sm font-semibold text-apex-navy-950">Register document</button>
        </form>
      </div>
    </main>
  );
