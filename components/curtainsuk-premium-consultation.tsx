...
export default function CurtainsUkPremiumConsultation() {
  ...
  return <main className={showUpload || showPalette ? `${referenceStyles.shell} ${styles.referenceHost}` : styles.shell}>
    ...
    {!showUpload && !showPalette && view.interiorBrief && (view.phase === 'brief' || view.phase === 'complete') && <section id="premium-current-step" className={styles.brief} aria-labelledby="brief-heading">
      <div className={styles.briefIntro}><p className={styles.eyebrow}>Your interior fabric brief</p><h1 id="brief-heading">A direction shaped <em>by you.</em></h1><p>We’ve brought together your room, what matters to you and the fabrics you responded to. This is the brief we’ll use to find your curtains.</p></div>
      <div className={styles.briefSources} aria-label="Sources of your brief"><span>Your room <small>Confirmed palette</small></span><span>Your taste <small>What matters to you</small></span><span>Your eye <small>Fabrics you responded to</small></span></div>
