...
Stock change `be6f48a12b5a3bb88d4e26dfbc7f1ef952f72dc1` is pushed and deployed to the gateway alias via `https://curtainsuk-staging-7lxj57woz-hamzas-projects-4ef62f35.vercel.app`, with server approval false and CALCULATE_ONLY. Full tests, typecheck, changed-file lint, local and hosted builds passed. Post-deployment HCI initialization was 200 (7.540s), cross-session adoption 409, foreign origin 403, forged cookie 401, anonymous staff HCI/stock endpoints 401. Database reads succeeded; no 504/520 observed in these checks. Audit verification rolled back and retained zero invented operator events. Security advisor reports the expected private service-only RLS/no-public-policy information and the existing leaked-password-protection warning; no public audit access was granted.
