...
export const WINDOW_TYPE_SEEDS: WindowTypeMaster[] = [
  ...
  defineWindowType({ canonicalName: "Bay Window", slug: "bay-window", family: "BAY_AND_CURVED", geometryType: "SEGMENTED_BAY", complexityClass: "CONFIGURABLE", requiredMeasurements: [BAY_SEGMENTS, BAY_ANGLES, DROP], recommendedTrackTypes: ["BAY_TRACK", "BENDABLE_TRACK"], photoRequired: true, instantPricingAllowed: false, relatedWindowTypes: ["bow-window", "corner-window"] }),
