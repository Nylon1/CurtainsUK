...
export const WINDOW_TYPE_SEEDS: WindowTypeMaster[] = [
  ...
  defineWindowType({ canonicalName: "Bay Window", slug: "bay-window", family: "BAY_AND_CURVED", geometryType: "SEGMENTED_BAY", complexityClass: "CONFIGURABLE", requiredMeasurements: [WIDTH, DROP], recommendedTrackTypes: ["BAY_TRACK", "BENDABLE_TRACK"], photoRequired: false, technicalReviewRequired: false, instantPricingAllowed: true, relatedWindowTypes: ["bow-window", "corner-window"] }),
