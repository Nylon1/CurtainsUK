...
export const STOREFRONT_WINDOW_TYPES: StorefrontWindowType[] = [
  ...
  entry({ slug: "bay-window", name: "Bay Window", eyebrow: "Angles made simple", description: "Bring separate bay sections together as one balanced, made-to-measure curtain scheme.", aliases: ["three-sided bay", "five-sided bay", "splayed bay"], masterSlugs: ["bay-window"], image: "/journey/decode-shape.jpeg", measurementGuidance: "Record each straight bay section, the angles between sections and the finished drop. Add a clear photograph for review.", trackGuidance: "Usually needs a made-to-fit bay or bendable track. Track geometry is reviewed with the curtain specification.", headings: trackHeadings, linings: allLinings, journey: "REVIEW" }),
  entry({ slug: "apex-window", name: "Apex Window", eyebrow: "Specialist sloping geometry", description: "Curtains engineered for dramatic pitched glazing and asymmetric rooflines.", aliases: ["peak window", "pitched window", "A-frame window"], masterSlugs: ["apex-window"], image: "/window-types/apex-hero.jpg", measurementGuidance: "Provide base width, peak height, both verticals and both slope lengths, plus photographs. Angles or a drawing can be added where known.", trackGuidance: "Requires a sloping or specialist track and technical approval before payment or manufacture.", headings: trackHeadings, linings: allLinings, journey: "SPECIALIST" }),
  entry({ slug: "triangular-window", name: "Triangular Window", eyebrow: "Measured point by point", description: "A reviewed curtain solution for triangular and sharply angled glazing.", aliases: ["triangle window", "angled top window", "sloped window"], masterSlugs: ["triangular-window"], image: "/window-types/triangular.jpeg", measurementGuidance: "Measure the base, overall peak, left and right verticals and both sloping sides. Photographs are required.", trackGuidance: "Track position and stack direction must be agreed during technical review.", headings: trackHeadings, linings: allLinings, journey: "SPECIALIST" }),
  entry({ slug: "gable-end-window", name: "Gable End Window", eyebrow: "Curtains for architectural scale", description: "Made-to-measure curtains for full-height gable glazing and feature elevations.", aliases: ["gable window", "gable glazing", "barn gable"], masterSlugs: ["gable-end-window"], image: "/window-types/gable-end.jpeg", measurementGuidance: "Capture the full base, peak height, side verticals and slope lengths. Include a wide room photograph showing access and fixing surfaces.", trackGuidance: "Usually combines sloping track sections with carefully planned opening and stack positions.", headings: trackHeadings, linings: allLinings, journey: "SPECIALIST" }),
