...
export const STOREFRONT_WINDOW_TYPES: StorefrontWindowType[] = [
  ...
  entry({ slug: "bay-window", name: "Bay Window", eyebrow: "Sections made simple", description: "Bring separate bay sections together as one balanced, made-to-measure curtain scheme.", aliases: ["three-sided bay", "five-sided bay", "splayed bay"], masterSlugs: ["bay-window"], image: "/journey/decode-shape.jpeg", measurementGuidance: "Record the number of sections, each section width and the finished drop. No bay angles are needed.", trackGuidance: "Curtain coverage is priced from the section widths. Any future track manufacture or fitting is reviewed separately.", headings: trackHeadings, linings: allLinings, journey: "STANDARD" }),
