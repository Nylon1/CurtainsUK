...
const base={aggregateMetres:30,confirmedUsageMetres:0,discontinued:false,snapshotDate:null,checkedAt:'2026-09-11T12:00:00Z'};
test('genuine stock is valid through exactly 96 hours, regardless of UK date or failed retrieval',()=>{
 for(const checkedAt of ['2026-09-15T12:00:00Z','2026-09-14T06:00:00Z','2026-09-11T12:00:00Z']){
...
test('expired, future or missing evidence requires confirmation, not an out-of-stock claim',()=>{
 for(const checkedAt of ['2026-09-11T11:59:59.999Z','2026-09-16T12:00:00Z','invalid',null]){
