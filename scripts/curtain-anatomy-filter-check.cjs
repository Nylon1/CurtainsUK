...
const tests = [['activity','low'],['activity','statement'],['pattern','abstract'],['pattern','stripe'],['pattern','geometric'],['pattern','botanical'],['texture','visible-weave'],['texture','relief'],['presence','light'],['presence','substantial']];
(async () => {
  const results = [];
