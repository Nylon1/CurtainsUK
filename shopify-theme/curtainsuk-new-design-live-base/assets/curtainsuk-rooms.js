(function () {
  ...
  // Restrained room illustrations are organisational cues, never fabric or curtain previews.
  function roomIllustration(room) {
    const furniture = {
      Bedroom:'<path d="M35 89V64h90v25M35 74h90M42 64V53h76v11M42 89v6m76-6v6"/><rect x="45" y="58" width="25" height="13" rx="3"/><rect x="90" y="58" width="25" height="13" rx="3"/>',
      'Dining Room':'<ellipse cx="80" cy="67" rx="43" ry="10"/><path d="M54 75v22m52-22v22M29 51v35h17m85-35v35h-17M29 86v11m102-11v11"/>',
      Kitchen:'<path d="M29 65h103v30H29zM29 71h103M63 71v24m35-24v24M34 56h28v9M108 65V52q0-8 8-8q7 0 7 8"/><path d="M42 80h10m22 0h10m24 0h10"/>',
      'Home Office':'<path d="M30 67h104M39 67v29m86-29v29M56 67V48h48v19M49 48h62M71 78h22v13H71zM82 91v7M72 98h20"/>',
      'Child’s Room':'<path d="M37 92V64h83v28M37 74h83M46 64V53h65v11M47 92v5m63-5v5"/><path d="m124 35 3 7 8 1-6 5 2 8-7-4-7 4 2-8-6-5 8-1z"/><circle cx="56" cy="61" r="6"/>',
      'Other Room':'<path d="M47 93V67q0-12 12-12h41q12 0 12 12v26M42 75h75v15H42zM48 90v7m64-7v7M126 95V56m-11 0h22l-5-16h-12z"/>'
    };
    return `<svg viewBox="0 0 160 115" aria-hidden="true" focusable="false"><path class="cukrooms__illustration-wall" d="M19 101V19h122v82"/><path d="M27 101h108M53 20v22h38V20M72 20v22M53 31h38"/>${furniture[room] || furniture['Other Room']}</svg>`;
  }
  ...
  document.querySelectorAll('[data-cuk-rooms]').forEach(root=>{
    ...
    function renderNextRooms() {
      return `<section class="cukrooms__next"><p class="cukrooms__eyebrow">Make yourself at home</p><h2>Which room is next?</h2><p>Give every room its own character.</p><div class="cukrooms__room-choices">${NEXT_ROOMS.map(name=>`<button class="cukrooms__room-choice" data-room-choice="${escape(name)}">${roomIllustration(name)}<span>${escape(name)}</span><span aria-hidden="true">↗</span></button>`).join('')}</div><button class="cukrooms__add-room" data-add-room>+ Add another room</button><div class="cukrooms__discovery"><a class="cukrooms__primary" href="${INTELLIGENCE}" data-new-room>Find fabric for another room →</a><a class="cukrooms__secondary" href="${BROWSE}" data-new-room>Browse fabrics</a></div></section>`;
    }
    function render(){
