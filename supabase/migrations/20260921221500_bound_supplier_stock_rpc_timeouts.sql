...
-- provides a bounded override. Normal stock batches and materialisation can
-- exceed that threshold, causing HTTP 500s after successful supplier retrieval.
--
-- Keep the override scoped to the stock evidence, approval, and materialisation
-- RPCs rather than widening the timeout for all service-role API traffic.
